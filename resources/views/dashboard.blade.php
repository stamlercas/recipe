            ...
            <div id="home" class="tab-pane in active">
              <h1>Welcome Back, {{ Auth::user()->first_name }}!</h1>
                <div>
                    ...
                    <!-- EXAMPLES:
                        Trending
                        Cuisine of the day (ex:  Their most popular cuisine is Mexican on Wednesday.  On Wednesday, display Taco Wednesday and a link to mexican dishes.  Or a link to past mexican dishes made or viewed on Wednesday.)
